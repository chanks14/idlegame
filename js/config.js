...
(function () {
  ...
  const CONFIG = {
    ...
    resources: {
      food:      { name: 'Food',      era: 0, color: '#8fd14f', legacy: 1,    desc: 'Roots, game and grain. The first currency of survival.' },
      stone:     { name: 'Stone',     era: 0, color: '#b8b0a2', legacy: 2,    desc: 'Flint and fieldstone, shaped by patient hands.' },
      bronze:    { name: 'Bronze',    era: 1, color: '#e8913f', legacy: 60,   desc: 'Copper and tin, wedded in fire.' },
      knowledge: { name: 'Knowledge', era: 1, color: '#6fa8ff', legacy: 40, pinned: true, headerUntil: 6, desc: 'Written memory. Spent on research in every later age.' },
      coin:      { name: 'Coin',      era: 2, color: '#ffcf3f', legacy: 3e3,  desc: 'Stamped silver that crosses every border.' },
      faith:     { name: 'Faith',     era: 3, color: '#e7a6ff', legacy: 1e5,  desc: 'Devotion, gathered in stone and song. Fuels the Rites.' },
      energy:    { name: 'Energy',    era: 4, color: '#fff06a', legacy: 3e6,  desc: 'Steam, coal and current. Powers the Grid.' },
      compute:   { name: 'Compute',   era: 5, color: '#3ee8a8', legacy: 1e8,  desc: 'Calculation at the speed of lightning.' },
      alloy:     { name: 'Alloy',     era: 6, color: '#9fc4e8', legacy: 1e10, desc: 'Orbital alloys forged in zero gravity.' },
      starmatter: { name: 'Starmatter', era: 7, color: '#c08cff', legacy: 1e12, pinned: true, desc: 'The pooled wealth of every claimed world. Builds colony ships.' },
      materiel:  { name: 'Materiel',  era: 8, color: '#ff8a5a', legacy: 1e14, desc: 'Munitions, armor plate and reactor fuel. Shipyards and barracks turn it into forces.' },
      warships:  { name: 'Warships',  era: 8, color: '#ff6060', legacy: 1e15, noHeader: true, desc: 'Void warships. Each adds to fleet strength; attrition destroys them.' },
